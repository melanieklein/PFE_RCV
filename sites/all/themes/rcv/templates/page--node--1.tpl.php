...
<div class="page">
  ...
  <div class="content" role="main">
     ...
     <div class="page-phrase-intro section"><?php print render($page['content']['system_main']['nodes']['1']['field_phrase_introduction'][0]['#markup']);?></div>

      <?php print render($page['content']['block_5']);?>

      <?php print render($page['content']['views_comite_organisateur-block']);?>

        <?php print render($page['content']['block_14']);?>
              <?php print render($page['content']['views_autres_passionnes-block']);?>
