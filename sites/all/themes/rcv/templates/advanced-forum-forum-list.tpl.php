    ...
    <div>
      <div>
        <?php if (empty($table_info->link)): ?>
          <h3 class="with-icon"><?php print $table_info->name; ?></h3>
        <?php else: ?>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th class="forum-topics"><?php print t('Sujets'); ?></th>
            <th class="forum-posts"><?php print t('Réponses'); ?></th>
            <th class="forum-last-post"><?php print t('Dernière réponse'); ?></th>
          </tr>
        </thead>
